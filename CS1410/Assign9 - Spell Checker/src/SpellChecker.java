...
public class SpellChecker {
    ...
    public static BinarySearchTree<String> readDictionary() {
        BinarySearchTree<String> tree = new BinarySearchTree<>();
        createDictionaryTree(tree);
        return tree;
    }

    public static void createDictionaryTree(BinarySearchTree<String> tree){
        //Extract the words from dictionary and put them into an array list
        ...
        //randomize the array list and then put them into the binary search tree
        java.util.Collections.shuffle(wordList, new java.util.Random(System.currentTimeMillis()));
        for(String word : wordList){
            tree.insert(word);
        }
    }
    public static void spellChecker(BinarySearchTree<String> tree){
    ...
    public static void check(String word, BinarySearchTree<String> tree){
        word = word.replace(",", "");
        word = word.replace(":", "");
        word = word.replace(".", "");
        word = word.replace("!", "");
